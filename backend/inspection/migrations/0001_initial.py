# Generated by Django 5.1.4 on 2026-09-22 07:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aid_code', models.CharField(max_length=40, verbose_name='航标编号')),
                ('attempted_by', models.CharField(max_length=64, verbose_name='操作者')),
                ('attempted_at', models.DateTimeField(auto_now_add=True, verbose_name='发生时刻')),
                ('conflicting_inspection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rejected_attempts', to='inspection.inspection', verbose_name='撞上的实测')),
            ],
            options={
                'ordering': ['-id'],
            },
